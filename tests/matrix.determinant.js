...
//     it('should return the only element in the matrix when given an 1x1 matrix', function() {
//         var a = [[1]];
//         var expected = 1;
...
//     it('should return the determinant of a 4- or higher-dimensional matrix', function() {
...
//     it('should throw MatrixError when not given a square matrix', function() {
//         var a = [[1, 2, 3], [4, 5, 6]];
